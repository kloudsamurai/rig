...
- `vector_search_simple.rs`: Basic vector search example.
- `vector_search_with_filters.rs`: Demonstrates advanced filtering in vector searches.
- `error_handling_example.rs`: Shows how to handle errors effectively.
- `hybrid_search_example.rs`: Example of performing hybrid searches.
- `update_and_delete_example.rs`: Demonstrates updating and deleting records.

You can find these examples in the [examples](./examples) directory.
